		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comyashsankeyexample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyashsankeyexample-display": {
								"semanticObject": "comyashsankeyexample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yash.sankeyexample",
									"url": sap.ui.require.toUrl("com/yash/sankeyexample")
								}
							}
						}
					}
